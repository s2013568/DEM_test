...
# Replace command-line argument with direct file path
file1 = "Ageng_based_simulation\\Chraibi_God_like_Code\\traj_133_av0.00_v01.00.txt"  # Replace with the actual path to your file
